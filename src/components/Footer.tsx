    ...
    <footer className="bg-gradient-hero text-primary-foreground">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="text-xl font-heading font-bold">EngAdmin</span>
              </div>
            </div>
            <p className="text-primary-foreground/70 text-sm leading-relaxed">
              Excelência em engenharia e administração desde 2010. Transformando projetos em realidade com qualidade e inovação.
            </p>
          </div>
        ...
        <div className="mt-10 pt-6 border-t border-primary-foreground/20 text-center text-sm text-primary-foreground/60">
          © {new Date().getFullYear()} EngAdmin. Todos os direitos reservados.
        </div>
      </div>
    </footer>
  );
